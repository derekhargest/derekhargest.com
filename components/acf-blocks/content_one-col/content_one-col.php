...
if ( $button_align ) {
	$button_align_class = $button_align;
};

$fields = get_field_objects($button_align);

enqueue_acf_component_assets($heading);

if ( $fields ) {
	foreach ( $fields as $field_name => $field ) {
		if ( $field['value'] ) {
			echo $field_name . ' = ' . $field['value'] . '<br />';
		}
	}
}

$fields = get_flexible_layout_fields();
