<div class="ai-buttons__wrapper">
	<div class="ai-icons">
		...
		<div class="ai-buttons closed">
			...
			<div class="ai-button">
				<a href="" class="ai-button-link" id="dj_button" title="Talk like a shock-jock radio DJ.">
					<i class="fa-solid fa-microphone-lines"></i>
				</a>
			</div>
			<div class="ai-button">
				<a href="" class="ai-button-link" id="king_button" title="Talk like a medieval shakesperean king.">
	...
	<div class="ai-button-heading">
		<h4><i class="fa-solid fa-turn-up"></i> Change my intro <br />with GPT!</h4>
	</div>
</div>